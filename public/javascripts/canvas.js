...
function init() {
    ...
    myDiagram.model = go.Model.fromJson({ "class": "go.TreeModel",
		...
		{"key":1, "parent":0, "text":"Node1", "brush":"skyblue", "dir":"right", "loc":"77 -22"},
		{"key":2, "parent":0, "text":"Node2", "brush":"darkseagreen", "dir":"right", "loc":"77 43"},
		{"key":3, "parent":0, "text":"Node3", "brush":"palevioletred", "dir":"left", "loc":"-20 -31.75"},
		{"key":4, "parent":0, "text":"Node4", "brush":"coral", "dir":"left", "loc":"-20 52.75"}
		]
		});   
  
   socket.on('conn', function (data){
      //alert('A User is connected to Edit');
      });
...
function load(){
  ...
  function addNodeAndLink(e, obj) {
    ...
    var newdata = { text: "Child Node", brush: olddata.brush, dir: olddata.dir, parent: olddata.key };
  ...
  function download()
{   
    var textToSave = myDiagram.model.toJson();
    var textToSaveAsBlob = new Blob([textToSave], {type:"text"});
    var textToSaveAsURL = window.URL.createObjectURL(textToSaveAsBlob);
    var fileNameToSaveAs = "diagram.txt";
